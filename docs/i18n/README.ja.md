...
Sisyphus は、大きなタスク管理ツールを開くほどではないけれど、頭の中に置き続けるには少し重い用事のための拡張です。`明日0930 ごはんを食べる`、`毎日2100 ごはんを食べる`、`金曜日1120 ごはんを食べる` のように、1 行で書けます。
...
<p align="center">
  <img src="../screenshots/ja/sisyphus-quick-add-demo.gif" width="420" alt="Sisyphus Quick Add parses tomorrow 09:30 meal todo and shows the extracted fields">
</p>

`明日0930 ごはんを食べる` は実際の popup flow で作成されます。リストにはタスク名の `ごはんを食べる` だけが残り、編集画面では解析された deadline と reminder time を確認できます。

**Global Reminder：24 時間形式を手入力**

<p align="center">
  <img src="../screenshots/ja/sisyphus-reminder-demo.gif" width="420" alt="Sisyphus global reminder panel manual 24-hour input demo">
</p>
...
<p align="center">
  <img src="../screenshots/ja/sisyphus-main.png" width="760" alt="Sisyphus browser popup">
  <br>
  <sub>ブラウザ Popup</sub>
</p>

<p align="center">
  <img src="../screenshots/ja/sisyphus-compose.png" width="760" alt="Sisyphus Quick Add">
  <br>
  <sub>Quick Add</sub>
</p>

<p align="center">
  <img src="../screenshots/ja/sisyphus-notification.png" width="760" alt="Sisyphus Chrome notification actions">
  <br>
...
<p align="center">
  <img src="../screenshots/ja/sisyphus-clean-main.png" width="420" alt="Sisyphus default main list close-up">
</p>

#### ヘッダーの非表示 / 表示

<p align="center">
  <img src="../screenshots/ja/sisyphus-clean-header.png" width="820" alt="Sisyphus header hidden and visible comparison">
</p>

#### Quick Add フォーム

<p align="center">
  <img src="../screenshots/ja/sisyphus-clean-quick-add.png" width="420" alt="Sisyphus Quick Add form close-up">
</p>

#### 毎日のリマインダー設定

<p align="center">
  <img src="../screenshots/ja/sisyphus-clean-reminder.png" width="420" alt="Sisyphus daily reminder panel close-up">
</p>

#### 通知ボタン

<p align="center">
  <img src="../screenshots/ja/sisyphus-clean-notification.png" width="560" alt="Sisyphus notification Snooze and Done close-up">
</p>
...
| 自然言語 Quick Add | `明日0930 ごはんを食べる`、`毎日2100 ごはんを食べる`、`12300217 ごはんを食べる` を構造化 todo にします。 |
...
| 入力 | 解析結果 | タスク名 |
| --- | --- | --- |
| `明日0930 ごはんを食べる` | due date = tomorrow、reminder = 09:30 | `ごはんを食べる` |
| `明後日0600 ごはんを食べる` | due date = day after tomorrow、reminder = 06:00 | `ごはんを食べる` |
| `明後日 0600 ごはんを食べる` | due date = day after tomorrow、reminder = 06:00 | `ごはんを食べる` |
| `毎日2100 ごはんを食べる` | repeat = daily、reminder = 21:00 | `ごはんを食べる` |
| `金曜日1120 ごはんを食べる` | due date = next Friday、reminder = 11:20 | `ごはんを食べる` |
...
対応 token: `今日`, `明日`, `明後日`, `日曜日` から `土曜日`, `毎日`, `毎週`, `毎月`, `HHMM`, `HH:MM`, `MMDDHHMM title`。中国語・韓国語の日付語も認識します。
...
| `明後日0600 ごはんを食べる` | 明後日と 06:00 を解析し、残りをタスク名にします。 |
